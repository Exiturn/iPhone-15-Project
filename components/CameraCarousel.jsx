        ...
        >
          {cameraCarouselSlides.map((slide, index) => (
            <li
              id="gallery-item"
              key={index}
              className="relative w-[274px] md:w-[692px] min-h-[490px] scroll-snap list-none"
            >
              <div id="card-item">
                <div
                  id="card-img-wrapper"
                ...
                >
                  ...
                  <img src={slide.imgSrc.src} alt={slide.imageText} className="w-full h-full object-cover" />
                </div>
              </div>
            </li>
          ))}
